...
def get_args():
    ...
    parser.add_argument('--test-file', default='none_n1000_k1_s0.json')
    ...
    parser.add_argument("--old-ema", dest="old_ema", help="Path to old model for incremental training")
    parser.add_argument('--use_char_emb', default=False, action="store_true",
                        help="use_char_emb")
