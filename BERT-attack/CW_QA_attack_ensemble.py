...
class CarliniL2QAEnsemble:
    ...
    def _optimize(self, optimizer, models, input_var, modifier_var, start_target_var, end_target_var, scale_const_var,
                  input_token=None):
        ...
        if self.mask is None:
            ...
            outputs = []
            for model in models:
                outputs.append(model(input_adv))
            ...
            outputs = []
            for model in models:
                outputs.append(model(**self.inputs))
        ...
        loss = 0
        for start_logits, end_logits in outputs:
